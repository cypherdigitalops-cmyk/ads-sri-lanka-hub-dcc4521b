...
export const BANNER_PRINTING_EXTRA_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    a: "Yes. Same-day banner printing is available in Colombo for orders placed with approved, print-ready artwork before 10:00 AM on working days. Standard sizes in 440gsm frontlit flex with eyelet finish are available for same-day turnaround. Call 0707310410 to confirm availability before sending artwork.",
  },
  {
