...
export const LED_SCREEN_RENTAL_EXTRA_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    a: "LED screen rental in Sri Lanka is quoted based on screen size, pixel pitch, event duration, location and whether additional services such as generator hire or live camera IMAG are required. Contact us on 0707310410 or WhatsApp with your event date, venue, approximate screen size requirement and number of attendees — we will provide a detailed written quotation within 2 working hours.",
  },
  {
