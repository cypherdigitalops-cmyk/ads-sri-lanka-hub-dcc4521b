...
const DESC = "Professional 3D printing in Sri Lanka — FDM, SLA resin & SLS prototyping, architectural models, custom parts & jigs from Rs 500. PLA, ABS, PETG, TPU, nylon & tough resin. Same-week delivery islandwide. WhatsApp 0707310410.";
