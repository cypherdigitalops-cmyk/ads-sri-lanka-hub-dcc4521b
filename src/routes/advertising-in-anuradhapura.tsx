...
const TITLE = "Advertising in Anuradhapura — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Anuradhapura, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Anuradhapura — with local rates, top locations and free guidance.";
const CITY = "Anuradhapura";
const SLUG = "advertising-in-anuradhapura";
...
export const Route = createFileRoute("/advertising-in-anuradhapura")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Maithripala Senanayake Mawatha, New Town, Nuwarawewa Road, Kandy Road, Mihintale Road, Jaffna Road, Sacred City entrance, Pubudu Mawatha, Stage I, Stage II.</p>
