...
const TITLE = "Advertising in Badulla — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Badulla, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Badulla — with local rates, top locations and free guidance.";
const CITY = "Badulla";
const SLUG = "advertising-in-badulla";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 6.9934, longitude: 81.055 },
};
...
export const Route = createFileRoute("/advertising-in-badulla")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-4">{CITY} is a key regional advertising market in Sri Lanka's Uva Province. Whether you're running a national brand campaign, a regional retail push or a hyper-local activation, our team covering {CITY} handles strategy, media buying, creative production and on-ground execution end-to-end.</p>
        ...
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Lower Street, Main Street, King Street, Bandaranayake Mawatha, Hali-Ela Road, Bandarawela Road, Ella Road, Passara Road, Welimada Junction, Hindagoda.</p>
