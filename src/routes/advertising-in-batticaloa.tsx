...
const TITLE = "Advertising in Batticaloa — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Batticaloa, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Batticaloa — with local rates, top locations and free guidance.";
const CITY = "Batticaloa";
const SLUG = "advertising-in-batticaloa";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 7.7102, longitude: 81.6924 },
};
...
export const Route = createFileRoute("/advertising-in-batticaloa")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Trinco Road, Bar Road, New Kalmunai Road, Kallady Bridge area, Puliyantheevu, Arasady, Kattankudy junction, Eravur Road, Polonnaruwa Road, Kalmunai Road.</p>
