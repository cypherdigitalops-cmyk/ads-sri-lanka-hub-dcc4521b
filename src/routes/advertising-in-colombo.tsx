...
const TITLE = "Advertising in Colombo — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Colombo, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Colombo — with local rates, top locations and free guidance.";
const CITY = "Colombo";
const SLUG = "advertising-in-colombo";
...
const FAQS = [
  ...
  { q: `Can you book billboards in ${CITY}?`, a: `Yes. We have access to prime hoarding locations across ${CITY} including Galle Road, Liberty Plaza, Town Hall — and we handle permits, printing and installation end-to-end.` },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3">Lake House (Daily News, Dinamina), Wijeya Group (Sunday Times, Lankadeepa), TV1, MTV, Hiru TV, Sirasa TV, Derana, Yes FM, TNL Radio.</p>
        <h3 className="mt-8 text-xl font-semibold text-foreground">Prime billboard & OOH locations in {CITY}</h3>
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Galle Road, Liberty Plaza, Town Hall, Nugegoda Junction, Kollupitiya, Bambalapitiya, Kotahena, Pettah, Borella, Battaramulla.</p>
