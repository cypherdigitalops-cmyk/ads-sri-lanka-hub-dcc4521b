...
const TITLE = "Advertising in Galle — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Galle, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Galle — with local rates, top locations and free guidance.";
const CITY = "Galle";
const SLUG = "advertising-in-galle";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 6.0535, longitude: 80.221 },
};
...
const FAQS = [
  ...
  { q: `Can you book billboards in ${CITY}?`, a: `Yes. We have access to prime hoarding locations across ${CITY} including Galle Fort entrance, Main Street, Karapitiya — and we handle permits, printing and installation end-to-end.` },
...
export const Route = createFileRoute(`/${SLUG}` as "/advertising-in-galle")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3">Ruhunu FM, Hiru FM Galle, Southern editions of Daily Mirror and Lankadeepa, ITN regional.</p>
        <h3 className="mt-8 text-xl font-semibold text-foreground">Prime billboard & OOH locations in {CITY}</h3>
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Galle Fort entrance, Main Street, Karapitiya, Hikkaduwa Road, Wakwella Road, Unawatuna junction.</p>
