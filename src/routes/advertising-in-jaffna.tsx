...
const TITLE = "Advertising in Jaffna — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Jaffna, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Jaffna — with local rates, top locations and free guidance.";
const CITY = "Jaffna";
const SLUG = "advertising-in-jaffna";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 9.6615, longitude: 80.0255 },
};
...
const FAQS = [
  ...
  { q: `Can you book billboards in ${CITY}?`, a: `Yes. We have access to prime hoarding locations across ${CITY} including Hospital Road, Kandy Road junction, Nallur — and we handle permits, printing and installation end-to-end.` },
...
export const Route = createFileRoute(`/${SLUG}` as "/advertising-in-jaffna")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3">Shakthi TV, Shakthi FM, Sooriyan FM, Thinakkural, Uthayan, Yarl FM — strong Tamil reach.</p>
        <h3 className="mt-8 text-xl font-semibold text-foreground">Prime billboard & OOH locations in {CITY}</h3>
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Hospital Road, Kandy Road junction, Nallur, KKS Road, Stanley Road, Chunnakam, Point Pedro Road.</p>
