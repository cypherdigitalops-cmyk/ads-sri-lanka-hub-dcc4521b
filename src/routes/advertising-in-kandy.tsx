...
const TITLE = "Advertising in Kandy — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Kandy, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Kandy — with local rates, top locations and free guidance.";
const CITY = "Kandy";
const SLUG = "advertising-in-kandy";
...
const FAQS = [
  ...
  { q: `Can you book billboards in ${CITY}?`, a: `Yes. We have access to prime hoarding locations across ${CITY} including Peradeniya Road, Kandy City Centre, Dalada Veediya — and we handle permits, printing and installation end-to-end.` },
...
export const Route = createFileRoute(`/${SLUG}` as "/advertising-in-kandy")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3">Sirasa TV regional, Hiru FM, Neth FM, Kandy Daily, regional pages of Lankadeepa and Daily Mirror.</p>
        <h3 className="mt-8 text-xl font-semibold text-foreground">Prime billboard & OOH locations in {CITY}</h3>
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Peradeniya Road, Kandy City Centre, Dalada Veediya, Peradeniya Junction, Katugastota, Pilimatalawa.</p>
