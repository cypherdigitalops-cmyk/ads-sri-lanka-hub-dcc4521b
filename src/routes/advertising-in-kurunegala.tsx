...
const TITLE = "Advertising in Kurunegala — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Kurunegala, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Kurunegala — with local rates, top locations and free guidance.";
const CITY = "Kurunegala";
const SLUG = "advertising-in-kurunegala";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 7.4863, longitude: 80.3623 },
};
...
const FAQS = [
  ...
  { q: `Can you book billboards in ${CITY}?`, a: `Yes. We have access to prime hoarding locations across ${CITY} including Puttalam Road, Kandy Road, Negombo Road — and we handle permits, printing and installation end-to-end.` },
...
export const Route = createFileRoute(`/${SLUG}` as "/advertising-in-kurunegala")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3">Hiru FM regional, Sirasa FM, Neth FM, Wayamba editions of Lankadeepa and Divaina.</p>
        <h3 className="mt-8 text-xl font-semibold text-foreground">Prime billboard & OOH locations in {CITY}</h3>
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Puttalam Road, Kandy Road, Negombo Road, Wehera Junction, North Lake Road, Maliyadeva junction.</p>
