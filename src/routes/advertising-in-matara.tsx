...
const TITLE = "Advertising in Matara — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Matara, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Matara — with local rates, top locations and free guidance.";
const CITY = "Matara";
const SLUG = "advertising-in-matara";
...
export const Route = createFileRoute("/advertising-in-matara")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Matara Town, Galle Road junction, Nupe, Weligama, Tangalle Road, Dickwella, Hakmana Road, Thihagoda, Akuressa Road, Polhena Beach Road.</p>
