...
const TITLE = "Advertising in Ratnapura — Complete Guide to Channels, Rates & Agencies";
const DESC = "Plan a winning campaign in Ratnapura, Sri Lanka. We cover billboards, radio, newspapers, TV, digital, BTL and activations in Ratnapura — with local rates, top locations and free guidance.";
const CITY = "Ratnapura";
const SLUG = "advertising-in-ratnapura";
...
const LOCAL_BUSINESS_JSONLD = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 6.6828, longitude: 80.4036 },
};
...
export const Route = createFileRoute("/advertising-in-ratnapura")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
        ...
        <p className="mt-4">{CITY} is a key regional advertising market in Sri Lanka's Sabaragamuwa Province. Whether you're running a national brand campaign, a regional retail push or a hyper-local activation, our team covering {CITY} handles strategy, media buying, creative production and on-ground execution end-to-end.</p>
        ...
        <p className="mt-3 flex items-start gap-2"><MapPin className="mt-1 h-4 w-4 flex-none text-accent" /> Main Street, Bandaranayake Mawatha, Colombo Road, Gem Market Junction, Eheliyagoda Road, Pelmadulla, Embilipitiya Road, Kalawana Road, Hidellana, Kuruwita.</p>
