...
const TITLE = "Banner Printing Sri Lanka 2026 | Flex from Rs 120/sqft – 24hr Delivery";
const DESC = "#1 banner printing in Sri Lanka — flex, vinyl, fabric, mesh & roll up banners from Rs 120/sqft. Free hemming + eyelets, 24-hour express, islandwide delivery. WhatsApp 0771437707 for an instant quote.";
