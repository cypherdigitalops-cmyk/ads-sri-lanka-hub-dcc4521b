...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you give written quotes?", acceptedAnswer: { "@type": "Answer", text: "Yes. Call 0707310410 or WhatsApp us for a free written quote tailored to your brief." } },
