...
const DESC = "Billboard printing in Sri Lanka — large-format hoardings, building wraps & roadside billboards from Rs 90/sqft. UV-stable inks, 510gsm flex. Call 0707310410.";
