...
export const Route = createFileRoute("/blog/activation-marketing-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="activation marketing sri lanka" extraLinks={[{"href":"/btl-advertising-sri-lanka","label":"BTL Advertising","anchor":"BTL advertising Sri Lanka"},{"href":"/brand-activation-sri-lanka","label":"Brand Activation","anchor":"brand activation Sri Lanka"},{"href":"/mall-activation-sri-lanka","label":"Mall Activation","anchor":"mall activation Sri Lanka"}]} /></PageShell>),
});
