...
export const Route = createFileRoute("/blog/advertising-video-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="advertising video sri lanka" extraLinks={[{"href":"/video-production-sri-lanka","label":"Video Production"},{"href":"/digital-marketing-sri-lanka","label":"Digital Marketing"},{"href":"/social-media-marketing-sri-lanka","label":"Social Media Marketing"}]} /></PageShell>),
});
