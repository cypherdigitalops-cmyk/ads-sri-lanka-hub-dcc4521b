...
export const Route = createFileRoute("/blog/door-to-door-marketing-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="door to door marketing sri lanka" extraLinks={[{"href":"/btl-advertising-sri-lanka","label":"BTL Advertising","anchor":"BTL advertising Sri Lanka"},{"href":"/field-marketing-sri-lanka","label":"Field Marketing","anchor":"field marketing Sri Lanka"}]} /></PageShell>),
});
