...
export const Route = createFileRoute("/blog/flyer-design-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="flyer design sri lanka" extraLinks={[{"href":"/branding-sri-lanka","label":"Branding & Creative","anchor":"branding Sri Lanka"},{"href":"/btl-advertising-sri-lanka","label":"BTL Advertising","anchor":"BTL advertising Sri Lanka"},{"href":"/printing-services-sri-lanka","label":"Printing Services","anchor":"printing services Sri Lanka"}]} /></PageShell>),
});
