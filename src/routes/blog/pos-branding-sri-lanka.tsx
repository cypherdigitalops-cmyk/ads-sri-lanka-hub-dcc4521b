...
export const Route = createFileRoute("/blog/pos-branding-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="POS branding sri lanka" extraLinks={[{"href":"/point-of-sale-advertising-sri-lanka","label":"Point Of Sale Advertising","anchor":"point of sale advertising Sri Lanka"},{"href":"/btl-advertising-sri-lanka","label":"BTL Advertising","anchor":"BTL advertising Sri Lanka"},{"href":"/retail-branding-sri-lanka","label":"Retail Branding","anchor":"retail branding Sri Lanka"}]} /></PageShell>),
});
