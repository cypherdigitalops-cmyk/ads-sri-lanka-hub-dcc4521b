...
export const Route = createFileRoute("/blog/reels-marketing-sri-lanka")({
  ...
  component: () => (<PageShell><BlogArticleTemplate category={CAT} keyword="reels marketing sri lanka" extraLinks={[{"href":"/social-media-marketing-sri-lanka","label":"Social Media Marketing"},{"href":"/instagram-marketing-sri-lanka","label":"Instagram Marketing"},{"href":"/video-production-sri-lanka","label":"Video Production"}]} /></PageShell>),
});
