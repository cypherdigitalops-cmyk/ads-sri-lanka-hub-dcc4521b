...
const DESC = "Custom packaging box printing in Sri Lanka. Product boxes, gift boxes & retail cartons with full-colour print. Die-cut & custom shapes available. Call 0707310410.";
