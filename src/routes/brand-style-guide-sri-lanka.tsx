...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional brand style guide design in Sri Lanka. Ensure your brand looks consistent across every channel. Call 0707310410 for a free quote.",
