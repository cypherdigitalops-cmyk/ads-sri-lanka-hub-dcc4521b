...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional brochure design in Sri Lanka — bi-fold, tri-fold and multi-page brochures for every industry. From Rs 8,000. Call 0707310410.",
  ...
  faqs: [
    ...
    { q: "Do you provide printing as well as design?", a: "Yes — we offer end-to-end service from design to print delivery. Call 0707310410 for a combined quote." },
  ],
  longForm: [
    {
