...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional brochure design in Sri Lanka — bi-fold, tri-fold and multi-page brochures for every industry. From Rs 8,000. Call 0701772626.",
  ...
  faqs: [
    ...
    { q: "Do you provide printing as well as design?", a: "Yes — we offer end-to-end service from design to print delivery. Call 0701772626 for a combined quote." },
  ],
  longForm: [
    {
