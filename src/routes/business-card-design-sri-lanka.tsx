...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional business card design in Sri Lanka from Rs 3,000. Premium designs for executives, entrepreneurs and businesses. Call 0707310410.",
  ...
  faqs: [
    ...
    { q: "Do you provide printing as well?", a: "Yes — we offer both design and printing services. Call 0707310410 for a combined design and print quote." },
  ],
  longForm: [
    {
