...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional product catalog design in Sri Lanka. Showcase your range and drive sales with a premium catalogue. From Rs 20,000. Call 0771437707.",
