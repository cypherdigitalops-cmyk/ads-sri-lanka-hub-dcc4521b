...
const DESC = "DTF printing in Sri Lanka from Rs 150 per transfer. Full-colour heat transfers for t-shirts, hoodies & bags. No minimum order. Any fabric colour. Call 0707310410.";
