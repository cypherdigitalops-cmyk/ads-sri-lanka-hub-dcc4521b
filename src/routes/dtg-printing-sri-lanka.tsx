...
const DESC = "DTG printing in Sri Lanka — photographic-quality full-colour print directly on t-shirts & garments. No minimum order. Any colour fabric. Call 0707310410.";
