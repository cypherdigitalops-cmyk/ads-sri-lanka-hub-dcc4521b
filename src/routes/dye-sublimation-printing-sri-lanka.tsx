...
const DESC = "Dye sublimation printing in Sri Lanka — fabric banners, sportswear, flags & tabletop graphics with full-colour photo-quality print. Call 0707310410.";
