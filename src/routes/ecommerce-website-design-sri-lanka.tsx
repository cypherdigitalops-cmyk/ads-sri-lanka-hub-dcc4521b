...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional e-commerce website design in Sri Lanka. Online stores built to sell — fast, mobile and conversion-ready. From Rs 80,000. Call 0707310410.",
