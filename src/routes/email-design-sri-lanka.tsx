...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional email template and newsletter design in Sri Lanka. Branded emails that get opened and clicked. From Rs 8,000. Call 0707310410.",
