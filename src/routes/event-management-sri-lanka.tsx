...
const DESC = "Event management in Sri Lanka for corporate events, weddings, MICE, exhibitions, brand activations & product launches. Full-service — stage, sound, LED, catering. 500+ events. Call 0707310410.";
...
export const Route = createFileRoute("/event-management-sri-lanka")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Event management in Sri Lanka — corporate events, weddings, MICE, exhibitions, brand activations and full production. Call 0707310410." },
    ],
