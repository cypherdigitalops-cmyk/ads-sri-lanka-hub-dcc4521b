...
const DESC = "Event rentals Sri Lanka — LED screens, sound, stages, lighting, tents, generators, photo booths & 17 categories. Delivered, set up & operated islandwide. Call 0707310410.";
...
function RentalsRankContent() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 text-foreground
      ...
      <ol>
        <li><strong>Determine your equipment needs.</strong> Use the event-type table above. Unsure on specs? Call 0707310410 or WhatsApp with event type, attendance and venue for free pre-booking guidance.</li>
