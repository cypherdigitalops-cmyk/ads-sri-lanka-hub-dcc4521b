...
const DESC = "Event signage printing in Sri Lanka — welcome boards, directional signs, table numbers & event banners. Fast turnaround. Islandwide. Call 0707310410.";
