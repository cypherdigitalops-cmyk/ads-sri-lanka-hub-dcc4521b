...
const DESC = "Custom flag printing in Sri Lanka — teardrop, feather, rectangle, table & national flags from Rs 3,500. Dye sublimation on premium polyester, pole + base included, 3–5 day delivery islandwide. WhatsApp 0707310410.";
