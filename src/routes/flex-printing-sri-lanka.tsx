...
const DESC = "Flex printing in Sri Lanka from Rs 120/sqft. Frontlit & backlit PVC flex for banners, hoardings & outdoor advertising. Any size, fast turnaround. Call 0707310410.";
