...
const DESC = "Floor sticker printing in Sri Lanka. Anti-slip certified floor graphics for retail, events & wayfinding. Temporary & permanent options. Call 0707310410.";
