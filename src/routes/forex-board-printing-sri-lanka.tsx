...
const DESC = "Forex board printing in Sri Lanka. Smooth surface PVC board for indoor & semi-outdoor signage. Any size, UV-printed, fast turnaround. Call 0707310410.";
