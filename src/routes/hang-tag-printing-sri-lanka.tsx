...
const DESC = "Hang tag printing in Sri Lanka from Rs 8 per tag. Branded clothing tags, price tags & product labels for fashion & retail. Any size. Call 0707310410.";
