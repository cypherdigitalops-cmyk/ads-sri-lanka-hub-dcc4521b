...
const DESC = "Invoice book printing in Sri Lanka. Duplicate & triplicate carbonless NCR books for retail, trade & services. Sequential numbering. Call 0707310410.";
