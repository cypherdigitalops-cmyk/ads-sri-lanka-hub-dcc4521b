...
const DESC = "Product label printing in Sri Lanka — paper, PP & waterproof labels on roll or sheet. From Rs 3 per label. Barcode & QR labels available. Call 0707310410.";
