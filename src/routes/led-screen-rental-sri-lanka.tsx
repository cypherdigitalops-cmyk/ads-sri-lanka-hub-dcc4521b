...
const DESC = "Looking for led screen rental sri lanka? Our Sri Lankan team plans, executes and delivers seamless led screen rental sri lanka with full production support. Free quote — call 0707310410 or WhatsApp.";
    ...
    <section className="mx-auto max-w-7xl px-4 py-12">
      ...
      <div className="mt-6 rounded-2xl border border-border bg-muted/30 p-5 text-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          <a href="https://wa.me/94707310410?text=Hi,%20I%20need%20help%20choosing%20the%20right%20LED%20screen%20size%20for%20my%20event%20in%20Sri%20Lanka" className="inline-flex items-center justify-center rounded-full border border-border bg-card px-5 py-3 text-sm font-semibold">WhatsApp for Size Guide</a>
        </div>
      </div>
    </section>
  );
