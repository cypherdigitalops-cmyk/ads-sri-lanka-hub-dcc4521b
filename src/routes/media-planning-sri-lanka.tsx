...
const DESC = "From concept to launch — full-service media planning sri lanka for Sri Lankan brands. Get pricing, timelines and channel options. Call 0701772626 today.";
