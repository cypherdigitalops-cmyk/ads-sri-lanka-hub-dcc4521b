...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional mobile app UI design in Sri Lanka for iOS and Android. Intuitive interfaces that users love. From Rs 60,000. Call 0707310410.",
