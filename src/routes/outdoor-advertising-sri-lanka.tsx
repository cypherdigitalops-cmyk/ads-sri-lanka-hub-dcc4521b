...
const TITLE = "Outdoor Advertising Solutions for Sri Lanka";
const DESC = "Billboards, LED screens, transit and OOH across Sri Lanka. Get pricing and free advice — call 0771437707 or WhatsApp.";
