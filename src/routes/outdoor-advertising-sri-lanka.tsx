...
const DESC = "Outdoor advertising Sri Lanka — billboards, digital DOOH, transit, mobile billboards & hoardings. Premium sites on Galle Road, Baseline Road & islandwide. Call 0707310410.";
...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "What are the best billboard locations in Sri Lanka?", acceptedAnswer: { "@type": "Answer", text: "Highest-value locations: Galle Road (80,000–200,000 daily impressions), Baseline Road (60,000–120,000), Kirulapona and Thurstan Road gantries (100,000–150,000) and One Galle Face Mall LED façade. Contact 0707310410 for site availability and a free media plan." } },
