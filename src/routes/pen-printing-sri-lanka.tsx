...
const DESC = "Pen printing in Sri Lanka — plastic, metal & executive pens with pad print, screen print or laser engraving. Any quantity, same-day Colombo. Call 0707310410.";
