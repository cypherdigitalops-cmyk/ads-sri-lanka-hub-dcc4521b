  ...
  component: () => (
    <PageShell>
      <CustomBlogArticle
        ...
        intro="From local government to presidential campaigns — voter research, messaging, posters, social media, SMS blasts, rally production, TV, radio and real-time media monitoring. Islandwide coverage. Call 0707310410."
        blocks={[
          ...
          { type: "callout", text: "Running for election? Call 0707310410 for a free, confidential strategy consultation. We work with candidates at all levels — local government to parliamentary." },
        ]}
        faqs={[
