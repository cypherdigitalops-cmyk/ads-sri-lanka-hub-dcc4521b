...
const DESC = "Roll label printing in Sri Lanka for automated labelling machines. Product, price & logistics labels on roll. PP, paper & waterproof options. Call 0707310410.";
