...
const DESC = "Security label printing in Sri Lanka. Void labels, tamper-evident seals, holographic stickers & serialised labels for product authentication. Call 0707310410.";
