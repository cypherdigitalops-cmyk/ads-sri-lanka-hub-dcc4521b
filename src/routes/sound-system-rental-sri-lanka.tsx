...
const DESC = "Reliable sound system rental for events in Sri Lanka. Get pricing, packages and free guidance — call 0707310410 or WhatsApp.";
...
export const Route = createFileRoute("/sound-system-rental-sri-lanka")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "sound system rental sri lanka, event management sri lanka, advertising sri lanka" },
      { property: "og:title", content: TITLE },
      { property: "og:description", content: DESC },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: `${SITE.url}/sound-system-rental-sri-lanka` }],
  }),
  component: () => (
    <PageShell>
      <ServicePageTemplate
        category={CAT}
        keyword="sound system rental sri lanka"
        extraLinks={[
