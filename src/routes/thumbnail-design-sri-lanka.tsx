...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional YouTube and video thumbnail design in Sri Lanka. Thumbnails that drive clicks and views. From Rs 1,500 per thumbnail. Call 0707310410.",
