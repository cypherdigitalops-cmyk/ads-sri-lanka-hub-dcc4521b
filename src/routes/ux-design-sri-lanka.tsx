...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional UX design services in Sri Lanka. User research, wireframes and prototypes for websites and apps. From Rs 40,000. Call 0707310410.",
