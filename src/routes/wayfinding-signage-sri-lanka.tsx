...
const DESC = "Wayfinding signage in Sri Lanka for hospitals, hotels & offices. Directional signs, room ID & navigation panels. Islandwide install. Call 0701772626.";
