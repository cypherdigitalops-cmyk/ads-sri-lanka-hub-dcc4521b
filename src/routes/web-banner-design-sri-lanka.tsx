...
const DATA: DesignSubService = {
  ...
  metaDescription: "Professional web banner and display ad design in Sri Lanka. Google Display ads, website banners and digital advertising graphics. From Rs 5,000. Call 0707310410.",
