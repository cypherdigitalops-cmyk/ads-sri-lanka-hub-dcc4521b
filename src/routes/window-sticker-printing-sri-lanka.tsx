...
const DESC = "Window sticker printing in Sri Lanka — custom decals, frosted film, one-way vision & shop window graphics. Any size, fast delivery islandwide. Call 0707310410.";
